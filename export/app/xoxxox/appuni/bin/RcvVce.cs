...
namespace Xoxxox {
  public class RcvVce: MonoBehaviour {
    ...
    private void Start() {
      ...
      trdbak.Start();
      objawd = this.gameObject.GetComponentInChildren<AudioSource>();
    }
    ...
    private void ExeBak() {
      while (true) {
        Debug.Log("RcvVce:bgn[]"); // DBG
        PolVce();
        Debug.Log("RcvVce:end[]"); // DBG
